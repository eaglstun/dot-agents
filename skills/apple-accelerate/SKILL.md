...
description: Apple Accelerate reference for BLAS/LAPACK, vDSP, vForce, simd, BNNS, Sparse Solvers, vImage,
  and Quadrature. Use when writing or debugging Accelerate code on Apple platforms, or choosing between
  Accelerate CPU work and Metal/MPS/Core ML.
metadata:
  version: 1.0.0
  public: true
  ...
  - 9qtYzd8uCRK2ymeWLe0J7wRf354MoAAB
  topic_id: v2:NKJH
