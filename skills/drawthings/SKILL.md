---
name: drawthings
description: Generate images locally with the Draw Things macOS app's built-in HTTP API (AUTOMATIC1111-compatible).
  Use when the user wants to generate, img2img, or inpaint an image through Draw Things, or mentions the
  Draw Things API.
metadata:
  version: 1.0.0
  public: true
  ...
  related_ids:
  - F6-pI0kqUJVt-Vl_7PalyvasfO8okAAI
