---
name: runpod
description: Deploy models to Runpod Serverless using cached Hugging Face models, Docker images, or network
  volumes; operate endpoints and track billing. Use when the user wants to host a fine-tuned model on
  Runpod, reduce cold starts, push a model version, or manage model storage and endpoint configuration.
metadata:
  version: 1.1.0
  public: true
