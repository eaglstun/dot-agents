---
name: xformers
description: xFormers reference for optimized PyTorch attention and related ops. Use for memory_efficient_attention,
  attention biases and packed sequences, backend dispatch and capability errors, SwiGLU/RoPE, performance
  problems, or xFormers/PyTorch/CUDA installation mismatches.
metadata:
  version: 1.0.0
  public: true
