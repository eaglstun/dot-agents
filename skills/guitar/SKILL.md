---
name: guitar
description: Create or format lead sheets, guitar chord charts, bass tablature, and engraved cello sheet
  music for OWNER/OPERATORS songs. Use when asked to format a lead sheet, create chord charts, write bass
  tabs, write a cello part / cello sheet music, or produce song charts.
metadata:
  version: 1.2.0
  public: true
