---
name: threejs
description: Version-specific Three.js reference for the phone VR project's pinned r132 renderer and desktop
  r180 visual techniques. Use when writing or debugging Three.js, choosing an effect implementation, or
  checking APIs and constraints for the correct project version.
metadata:
  public: true
