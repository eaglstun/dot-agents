...
> `node_modules/three/build/three.module.js` + `three.core.js` in
> `~/Documents/web/carpriccio`, diffed against `0.132.2` in
> `~/Documents/dev/karaoke-headset`. When the live docs and this doc disagree, trust this doc.
