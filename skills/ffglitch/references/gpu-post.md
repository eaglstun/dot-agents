...
Crosslink syntax per `~/.agents/skills/cuda/references/gpu-rosetta.md` — skill-local files
...
- [[apple-metal:per-eye-temporal-accumulation]] — the headset renderer's cousin of glitchgpu's trails (accumulation without breaking stereo).
