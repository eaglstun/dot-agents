---
name: headset
description: Project reference for phone-in-headset VR using a native iOS WebView and pinned Three.js
  r132 without WebXR. Use for stereo rendering, head tracking, lens/IPD tuning, clicker input, motion
  permissions, the native shell, and project-specific API constraints.
metadata:
  version: 1.0.0
  public: true
