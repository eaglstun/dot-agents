---
name: swift
description: Swift language and SwiftPM reference for apps, packages, CLIs, and servers. Use when writing,
  reviewing, refactoring, or debugging Swift, especially API design, ownership and ARC, generics and protocols,
  Swift 6 concurrency, package organization, and version migrations.
metadata:
  version: 1.0.0
  public: true
  ...
  - SKwWgOlR5YVaNQBMLpFHEilw61UkcAAA
---
