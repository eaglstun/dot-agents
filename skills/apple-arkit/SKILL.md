---
name: apple-arkit
description: Apple native-iOS sensing reference for the phone-in-headset VR project. Use for ARKit, Core
  Motion, camera and LiDAR depth, face or hand tracking, placement, and native-to-WKWebView bridging questions.
metadata:
  version: 1.0.0
  public: true
