---
name: game-consoles
description: Hardware reference for classic consoles and 8-bit computers as style targets in modern renderers
  and synths. Use to reproduce a machine's real display, palette, sprite, timing, and sound constraints,
  or diagnose why retro-styled visuals or audio feel wrong.
metadata:
  public: true
