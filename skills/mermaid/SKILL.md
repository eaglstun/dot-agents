---
name: mermaid
description: Add and edit Mermaid diagrams (flowcharts, sequence, state, ER, class, gantt, etc.) inside
  any Markdown file. Use when asked to add/insert/draw a diagram, flowchart, or chart in Markdown, visualize
  a flow/process/architecture/state machine as Mermaid, or fix/validate an existing ```mermaid block.
metadata:
  version: 1.0.0
  public: true
