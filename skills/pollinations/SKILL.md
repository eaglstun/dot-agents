---
name: pollinations
description: Generate images, videos, text-to-speech audio, music, and chat/text completions using the
  Pollinations.AI API. Use when the user asks to create/generate an image, video clip, voiceover, speech,
  or music, or wants to call an LLM through Pollinations.
metadata:
  version: 1.0.0
  public: true
