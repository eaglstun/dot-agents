---
name: together
description: Direct calls to Together AI's OpenAI-compatible API for text completions, vision, embeddings,
  and image/speech generation. Models include Qwen3-235B, MiniMax-M2, Llama 3.3 70B, DeepSeek, and Black
  Forest Labs FLUX. Use for raw LLM output (translation, classification, drafting, fast chat) when you
  want a single OpenAI-compatible endpoint without extra agent overhead.
metadata:
  version: 1.0.0
  public: true
