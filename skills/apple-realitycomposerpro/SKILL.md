...
description: Reality Composer Pro 3 reference for scene authoring, entities, materials, Shader and Compute
  Graphs, particles, animation, behaviors, navigation, and spatial audio. Use when building or debugging
  RCP content or integrating its scenes with Swift.
metadata:
  version: 1.0.0
  public: true
