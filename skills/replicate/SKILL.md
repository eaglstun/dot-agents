---
name: replicate
description: Run Replicate-hosted models for video, image, audio, music, or text generation. Use when
  the user requests AI video, explicitly mentions Replicate or a Replicate model slug, or wants media
  generated through an existing Replicate account.
metadata:
  version: 1.0.0
  public: true
