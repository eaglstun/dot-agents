...
Entry point is [SKILL.md](SKILL.md); references live in
[`references/`](references/) (the `ct2-internals` crosslink shelf), each sourced from the actual code with file:line
