---
name: ct2-internals
description: 'CTranslate2 engine internals — the device/dtype-agnostic architecture below any compute
  backend. Use when working in src/ops, src/layers, src/models, the dispatch machinery, StorageView, or
  the Python specs/converters import pipeline: how an op is structured and dispatched, how tensors are
  represented, how transformer blocks are wired (norm placement etc.), and how external checkpoints become
  CT2 models.'
metadata:
  version: 1.0.0
  public: true
...
- See the shelf README (`references/README.md`) for the
