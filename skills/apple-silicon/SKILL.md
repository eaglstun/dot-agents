---
name: apple-silicon
description: Apple Silicon GPU and Metal compute reference for PyTorch MPS, CTranslate2, and standalone
  Metal projects. Use for MSL kernels, dispatch sizing, MPS GEMM/graphs, synchronization, memory, low-precision
  numerics, and Objective-C++ interop.
metadata:
  version: 1.0.0
  public: true
