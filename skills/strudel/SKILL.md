---
name: strudel
description: Write, debug, and play Strudel live-coding music patterns. Use for mini-notation, rhythm
  and melody, effects, visualizations, MIDI/OSC, browser-project work, or playback through the dj-claude
  tools. Use tidal-cycles for native Tidal code.
metadata:
  version: 1.0.0
  public: true
  ...
  - KCyLbTIJso-NGBQjISoP6DC7UWcNUAAA
---
...
## The house project: `~/Documents/dev/strudel`

Paths below (`index.js`, `songs/`, `vite.config.js`) are relative to that directory —
it's the reference implementation for everything in this skill. In any other Strudel
project the patterns still apply; the file names won't.
