...
description: >-
  ...
  cost + license. Grounded in `~/.agents/skills/gen-3d/references/`. This is the GENERATIVE counterpart to
...
GLB loader + Metal linear-blend skinning, spec'd in `~/.agents/skills/gen-3d/references/native-skinning-runtime.md`
...
1. `~/.agents/skills/gen-3d/references/rig-and-animate-apis.md` — the vendor decision (this is your map):
...
2. `~/.agents/skills/gen-3d/references/native-skinning-runtime.md` — the consumption spec. Read it for the
...
3. `~/.agents/skills/gen-3d/references/tripo-api.md` — the concrete Tripo REST contract (base URL, auth,
